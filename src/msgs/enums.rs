...
enum_builder! {
    ...
    EnumVal{
        ...
        MQDSS3148 => 0x09,
        MQDSS3164 => 0x0a,
        RAINBOW_IA_CLASSIC => 0x0b,
        RAINBOW_IA_CYCLIC => 0x0c,
        RAINBOW_IA_CYCLIC_COMPRESSED => 0x0d,
        RAINBOW_II_ICCLASSIC => 0x0e,
        RAINBOW_II_IC_CYCLIC => 0x0f,
        RAINBOW_II_IC_CYCLIC_COMPRESSED => 0x10,
        RAINBOW_VC_CLASSIC => 0x11,
        RAINBOW_VC_CYCLIC => 0x12,
        RAINBOW_VC_CYCLIC_COMPRESSED => 0x13,
        SPHINCS_HARAKA128F_ROBUST => 0x14,
        SPHINCS_HARAKA128F_SIMPLE => 0x15,
        SPHINCS_HARAKA128S_ROBUST => 0x16,
        SPHINCS_HARAKA128S_SIMPLE => 0x17,
        SPHINCS_HARAKA192F_ROBUST => 0x18,
        SPHINCS_HARAKA192F_SIMPLE => 0x19,
        SPHINCS_HARAKA192S_ROBUST => 0x1a,
        SPHINCS_HARAKA192S_SIMPLE => 0x1b,
        SPHINCS_HARAKA256F_ROBUST => 0x1c,
        SPHINCS_HARAKA256F_SIMPLE => 0x1d,
        SPHINCS_HARAKA256S_ROBUST => 0x1e,
        SPHINCS_HARAKA256S_SIMPLE => 0x1f,
        SPHINCS_SHA256128F_ROBUST => 0x20,
        SPHINCS_SHA256128F_SIMPLE => 0x21,
        SPHINCS_SHA256128S_ROBUST => 0x22,
        SPHINCS_SHA256128S_SIMPLE => 0x23,
        SPHINCS_SHA256192F_ROBUST => 0x24,
        SPHINCS_SHA256192F_SIMPLE => 0x25,
        SPHINCS_SHA256192S_ROBUST => 0x26,
        SPHINCS_SHA256192S_SIMPLE => 0x27,
        SPHINCS_SHA256256F_ROBUST => 0x28,
        SPHINCS_SHA256256F_SIMPLE => 0x29,
        SPHINCS_SHA256256S_ROBUST => 0x2a,
        SPHINCS_SHA256256S_SIMPLE => 0x2b,
        SPHINCS_SHAKE256128F_ROBUST => 0x2c,
        SPHINCS_SHAKE256128F_SIMPLE => 0x2d,
        SPHINCS_SHAKE256128S_ROBUST => 0x2e,
        SPHINCS_SHAKE256128S_SIMPLE => 0x2f,
        SPHINCS_SHAKE256192F_ROBUST => 0x30,
        SPHINCS_SHAKE256192F_SIMPLE => 0x31,
        SPHINCS_SHAKE256192S_ROBUST => 0x32,
        SPHINCS_SHAKE256192S_SIMPLE => 0x33,
        SPHINCS_SHAKE256256F_ROBUST => 0x34,
        SPHINCS_SHAKE256256F_SIMPLE => 0x35,
        SPHINCS_SHAKE256256S_ROBUST => 0x36,
        SPHINCS_SHAKE256256S_SIMPLE => 0x37,
        PICNIC_L1_FS => 0x38,
        PICNIC_L1_UR => 0x39,
        PICNIC_L3_FS => 0x3a,
        PICNIC_L3_UR => 0x3b,
...
enum_builder! {
    ...
    EnumVal{
        ...
        KYBER102490S => 0x0202,
        BABYBEAR => 0x0203,
        BABYBEAREPHEM => 0x0204,
        MAMABEAR => 0x0205,
        MAMABEAREPHEM => 0x0206,
        PAPABEAR => 0x0207,
        PAPABEAREPHEM => 0x0208,
        LIGHTSABER => 0x0209,
        SABER => 0x020a,
        FIRESABER => 0x020b,
        LEDAKEMLT12 => 0x020c,
        LEDAKEMLT32 => 0x020d,
        LEDAKEMLT52 => 0x020e,
        NEWHOPE512CPA => 0x020f,
        NEWHOPE512CCA => 0x0210,
        NEWHOPE1024CPA => 0x0211,
        NEWHOPE1024CCA => 0x0212,
        NTRUHPS2048509 => 0x0213,
        NTRUHPS2048677 => 0x0214,
        NTRUHPS4096821 => 0x0215,
        NTRUHRSS701 => 0x0216,
        FRODOKEM640AES => 0x0217,
        FRODOKEM640SHAKE => 0x0218,
        FRODOKEM976AES => 0x0219,
        FRODOKEM976SHAKE => 0x021a,
        FRODOKEM1344AES => 0x021b,
        FRODOKEM1344SHAKE => 0x021c,
        MCELIECE348864 => 0x021d,
        MCELIECE348864F => 0x021e,
        MCELIECE460896 => 0x021f,
        MCELIECE460896F => 0x0220,
        MCELIECE6688128 => 0x0221,
        MCELIECE6688128F => 0x0222,
        MCELIECE6960119 => 0x0223,
        MCELIECE6960119F => 0x0224,
        MCELIECE8192128 => 0x0225,
        MCELIECE8192128F => 0x0226,
        HQC1281CCA2 => 0x0227,
        HQC1921CCA2 => 0x0228,
        HQC1922CCA2 => 0x0229,
        HQC2561CCA2 => 0x022a,
