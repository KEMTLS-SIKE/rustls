match scheme {
    ...
    SignatureScheme::KEMTLS_FRODOKEM640AES1CCA => include_bytes!("data/alg-frodokem640aes1CCA.der"),
    SignatureScheme::KEMTLS_FRODOKEM640SHAKE => include_bytes!("data/alg-frodokem640shake.der"),
    SignatureScheme::KEMTLS_FRODOKEM640SHAKE1CCA => include_bytes!("data/alg-frodokem640shake1CCA.der"),
    SignatureScheme::KEMTLS_FRODOKEM976AES => include_bytes!("data/alg-frodokem976aes.der"),
    SignatureScheme::KEMTLS_FRODOKEM976AES1CCA => include_bytes!("data/alg-frodokem976aes1CCA.der"),
    SignatureScheme::KEMTLS_FRODOKEM976SHAKE => include_bytes!("data/alg-frodokem976shake.der"),
    SignatureScheme::KEMTLS_FRODOKEM976SHAKE1CCA => include_bytes!("data/alg-frodokem976shake1CCA.der"),
    SignatureScheme::KEMTLS_FRODOKEM1344AES => include_bytes!("data/alg-frodokem1344aes.der"),
    SignatureScheme::KEMTLS_FRODOKEM1344AES1CCA => include_bytes!("data/alg-frodokem1344aes1CCA.der"),
    SignatureScheme::KEMTLS_FRODOKEM1344SHAKE => include_bytes!("data/alg-frodokem1344shake.der"),
    SignatureScheme::KEMTLS_FRODOKEM1344SHAKE1CCA => include_bytes!("data/alg-frodokem1344shake1CCA.der"),
    ...
    SignatureScheme::KEMTLS_SIKEP434COMPRESSED1CCA => include_bytes!("data/alg-sikep434compressed1cca.der"),
    ...
    SignatureScheme::KEMTLS_SIKEP503COMPRESSED1CCA => include_bytes!("data/alg-sikep503compressed1cca.der"),
    ...
    SignatureScheme::KEMTLS_SIKEP610COMPRESSED1CCA => include_bytes!("data/alg-sikep610compressed1cca.der"),
    ...
    SignatureScheme::KEMTLS_CSIDHP1024 => include_bytes!("data/alg-csidhp1024.der"),
