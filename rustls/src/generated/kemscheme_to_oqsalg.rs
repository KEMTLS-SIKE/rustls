match scheme {
    ...
    SignatureScheme::KEMTLS_FRODOKEM640AES1CCA => oqs::kem::Algorithm::FrodoKem640Aes1CCA,
    SignatureScheme::KEMTLS_FRODOKEM640SHAKE => oqs::kem::Algorithm::FrodoKem640Shake,
    SignatureScheme::KEMTLS_FRODOKEM640SHAKE1CCA => oqs::kem::Algorithm::FrodoKem640Shake1CCA,
    SignatureScheme::KEMTLS_FRODOKEM976AES => oqs::kem::Algorithm::FrodoKem976Aes,
    SignatureScheme::KEMTLS_FRODOKEM976AES1CCA => oqs::kem::Algorithm::FrodoKem976Aes1CCA,
    SignatureScheme::KEMTLS_FRODOKEM976SHAKE => oqs::kem::Algorithm::FrodoKem976Shake,
    SignatureScheme::KEMTLS_FRODOKEM976SHAKE1CCA => oqs::kem::Algorithm::FrodoKem976Shake1CCA,
    SignatureScheme::KEMTLS_FRODOKEM1344AES => oqs::kem::Algorithm::FrodoKem1344Aes,
    SignatureScheme::KEMTLS_FRODOKEM1344AES1CCA => oqs::kem::Algorithm::FrodoKem1344Aes1CCA,
    SignatureScheme::KEMTLS_FRODOKEM1344SHAKE => oqs::kem::Algorithm::FrodoKem1344Shake,
    SignatureScheme::KEMTLS_FRODOKEM1344SHAKE1CCA => oqs::kem::Algorithm::FrodoKem1344Shake1CCA,
    ...
    SignatureScheme::KEMTLS_SIKEP434COMPRESSED1CCA => oqs::kem::Algorithm::SikeP434Compressed1CCA,
    ...
    SignatureScheme::KEMTLS_SIKEP503COMPRESSED1CCA => oqs::kem::Algorithm::SikeP503Compressed1CCA,
    ...
    SignatureScheme::KEMTLS_SIKEP610COMPRESSED1CCA => oqs::kem::Algorithm::SikeP610Compressed1CCA,
    ...
    SignatureScheme::KEMTLS_CSIDHP1024 => oqs::kem::Algorithm::CsidhP1024,
